...
const posts = [
    {
        ...
        date: '2025-11-03',
        excerpt: '关于这个小站是干啥的',
        content: '# 创建这个博客的目的\n\n记录一些小思绪，可能是精神分析，也可能是llmagent的使用感想，更可能是牢骚。有些东西不管发布在知乎，b站，抖音还是小红书，都感觉很怪。\n\n## 部署过程\n\n现在是2025年，创建个人博客有如70年入国军。不过感谢于此，我得以用不超过两小时的时间成本完成了从学习了解到域名购买到博客建立，在此之前，我的cs水平仅限于寻找盗版steam游戏。这个小站的建立要感谢ai coding的发展，因为程序和部署都是ai完成的。\n\n毫无疑问，会有很多问题，我会尝试学习部分知识，反正现成的例子就在这里。\n\n## 动机\n\n建立自己博客的想法实际上很久了。sinyalee和他的大作（大嘘）算是一个推手，后面会把读后感传一下。\n\n## 博客内容\n\n想到哪里写哪里，会尝试兼顾审美，严谨性和道德（排名分先后），但是对于接受不了的人大概是接受不了',
        tags: ['博客']
    } ,
    {
        id: 'perfume',
    ...
    } ,
    {
        ...
        date: '2025-11-05',
        excerpt: '男，女，理想化身',
        content: '停止闹剧\n\n我之所以没有变成sinyalee那个样子，很大程度上是因为做好了课题分离。理想化身是白月光，其他女生是其他女生，其他女生不应该成为我对理想化身情感的代餐，转嫁，中介等等。不然只是在找个新妈而已。\n\n一些可能面对理想化身时拉不下来脸皮的手段和技巧可以应用出来，比如弃猫，调用脚本思想之类的。同样，面对理想化身时仍应保持内心纯净，面具能摘能带才是好的\n\n\n\n（常规的）男女关系就像爬楼梯，向上爬就被认为是渴求和欲望，而且是很费力地被怜悯；向下就被认为是爱和包容，姿态高高在上，不费吹灰之力\n\n某些人所说的天生有爱人的能力大概如此，明明自己在这套狗屁体系里只有三层楼，却假装自己在三十层楼的位置，高高在上地俯视，殊不知虚假的高度是有毒的\n\n而你，7thmun，我的朋友，你在平流层（图穷匕见）',
        tags: ['社交']
    } ,
    {
        id: 'market',
        ...
        date: '2025-11-07',
        excerpt: '但马上不是了',
        content: '我们的消费中，似乎有一些是阴性的，比如衣物，鞋子，各种包，一些车，房等。有一些是阳性的：摄像机，水杯，鱼竿，弓箭，另一些车....等等。实际上健康的消费总是阴阳并济的。\n\n导致一个消费拥有阴/阳性属性的，是这个物件（乃至服务）的“意义”or“目的”在于包容/彰显。或者一个简单粗暴的理解：和阳具有象征关系的就是阳性消费，和阴部有象征关系的就是阴形消费。具体要辩证的看，举例子：\n\n1：单反粗长可伸缩的镜头和阴茎类似，毫无疑问ta是阳性的。但如果是有（比如说打鸟）需求，那他就是阴形的，因为用来容纳图像了\n\n2：显卡应被认为阴性还是阳性的呢？答案分为两种，像是臭打游戏所用的RTX，就是阳性居多。因为玩家只想追求更高的帧率/跑分，这实际上是一个勃起的过程。但深度学习里的卡则相反，因为这些卡是子宫，在有限时间内容纳llm成长的子宫。\n\n3：有一些看起来是阴性的物品可以发挥阳性，好比车，阿尔法很能装（阴）也能装（阳）。roma，db11，amggt，玛莎gt等一众大gt同样如此，虽然他不快但是他稳啊，这是一种阴性，而他作为个人名片出现时，或是展示v8v12时，他就是在展示阳性。\n\n这么分类，是为了揭示一种交换。消费可以象征为：物品（和服务）的阴性通过容纳消费者的阳性从而占据消费者的阳性，进一步的，消费者将消费品变为自身的阳性。如同性交，是受精方通过性行为分享或夺取给精方的阳具，给精方通过抚摸将受精方变成自己的阳具。\n\n当然，消费品中阳性的存在是必要的，因为人不傻，不会任由自己阳具被无条件地分割。这是同性恋的部分，放在以后再说。\n\n# 为什么说像电解池\n\n由阳性填补阴性是非天然过程，如同电解池，外加电动势驱动。而过程中产生的电流方向就对应着转移支付方向。在经济上行周期时，流动性由阳极向阴极流动。\n\n下行周期时，由于失去了外在电动势的推动，电流反向，阴性通过屈折来填补阳性，流动性从阴性转移至阳性。由于笔者未经历过经济下行年代，故想象不到那是什么场景，略\n\n关于“电动势”的被象征是什么，我不清楚，初步感觉，可能是共识一类的东西。改日再谈',
        tags: ['象征']
    } 
];
