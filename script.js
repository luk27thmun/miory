...
const posts = [
    ...
    } ,
    {
        ...
        date: '2025-11-07',
        excerpt: '但马上不是了',
        content: '我们的消费中，有一些是阴性的，比如衣物，鞋子，各种包，一些车，房等。有一些是阳性的：摄像机，水杯，鱼竿，弓箭，另一些车....等等。更有一些则是阴阳并济。\n\n决定一个消费拥有阴/阳性属性的，是这个物件（乃至服务）的“目的”在于包容/彰显。或者说一个简单粗暴的理解：和阳具有象征关系的就是阳性消费，和阴部有象征关系的就是阴形消费。具体要辩证的看，举例子：\n\n1：单反粗长可伸缩的镜头和阴茎类似，毫无疑问ta是阳性的。但如果是有（比如说打鸟）需求，那他就是阴形的，因为用来容纳图像了\n\n2：显卡应被认为阴性还是阳性的呢？答案分为两种，像是臭打游戏所用的RTX，就是阳性居多。因为玩家只想追求更高的帧率/跑分，这实际上是一个勃起的过程。但深度学习里的卡则相反，因为这些卡是子宫，在有限时间内容纳llm成长的子宫。\n\n3：有一些看起来是阴性的物品可以发挥阳性，好比车，阿尔法很能装（阴）也能装（阳）。roma，db11，amggt，玛莎gt等一众大gt同样如此，虽然他不快但是他稳啊，这是一种阴性，而他作为整体出现时，或是展示v8v12时，他就是在展示阳性。\n\n这么分类，是为了揭示一种交换：消费的真正意义是物品（和服务）的阴性通过容纳消费者的阳性从而占据消费者的阳性，进一步的，消费者将消费品变为自身的阳性。如同性交，是受精方通过性行为分享或夺取给精方的阳具，给精方通过抚摸将受精方变成自己的阳具。\n\n当然，消费品中阳性的存在是必要的，因为人不傻，不会任由自己阳具被无条件地分润。这是同性恋的部分，放在以后再说。\n\n##为什么说像电解池\n\n由阳性填补阴性是非天然过程，如同电解池，外加电动势驱动。而过程中产生的电流方向就对应着转移支付方向。在经济上行周期时，流动性由阳极向阴极流动。\n\n下行周期时，由于失去了外在电动势的推动，电流反向，阴性通过屈折来填补阳性，流动性从阴性转移至阳性。由于笔者未经历过经济下行年代，故想象不到那是什么场景，略\n\n关于“电动势”的被象征是什么，我不清楚，初步感觉，可能是共识一类的东西。改日再谈',
        tags: ['象征']
    } 
];
